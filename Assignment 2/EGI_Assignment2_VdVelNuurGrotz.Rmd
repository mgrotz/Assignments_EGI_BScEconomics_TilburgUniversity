...
for (i in 2:nrow(sim3)){
  ...
  sim3$m[i] <- x*(1-((sim3$sm)/w))^epsilon*sim3$Z[i]  # !!!!!!!!!!!!!!!!! Here is the jewel problem !!!!!!!!!!!!!!!!!!!!!!! The sm was added within the dataframe, unlike the former sm s. Maybe it's how i formulated it??, I maded it sim3$sm ~Abdo, 9Apr2022
